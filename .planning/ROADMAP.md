...
- [ ] 04-02-PLAN.md — AUTH-05: every access token the plugin can read ends its Emby session
...
| 4. The Fingerprint Store, and Emby Traffic Under Failure | 1/8 | In Progress|  |
