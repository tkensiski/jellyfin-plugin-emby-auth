...
- [ ] 02-01-PLAN.md — The JavaScript test harness, end to end, and the UI-01 load-failure message with the Save button turned off

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 02-02-PLAN.md — The UI-02 save-failure message, the rest of the TEST-04 coverage, and the documentation of both
...
| 2. Safe Failures for the Fingerprint File and Settings | 0/3 | Planned | - |
