...
- [ ] 01-01-PLAN.md — Unit-test seam for `EmbyAuthenticationProvider`, and every AUTH-04 failure path closed behind it

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-02-PLAN.md — Full TEST-01 coverage, the AUTH-03 save-directly-after-create ordering, and the account-creation window documented
...
|-------|----------------|--------|-----------|
| 1. Account Creation and Login Security | 0/4 | Planned | - |
