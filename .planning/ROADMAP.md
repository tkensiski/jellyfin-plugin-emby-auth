...
**Success Criteria** (what must be TRUE):
  1. Unit tests make the save after `CreateUserAsync` fail, make the cleanup delete fail as well, and throw an unexpected exception type. In each case the login is refused without HTTP 500, and no enabled account stays on the Default login method without a password.
...
|-------|----------------|--------|-----------|
| 1. Account Creation and Login Security | 0/TBD | Not started | - |
