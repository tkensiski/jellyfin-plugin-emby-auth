...
- [ ] 04-03-PLAN.md — PERF-01: concurrent readers on an expired user list snapshot send one Emby request
...
| 4. The Fingerprint Store, and Emby Traffic Under Failure | 2/8 | In Progress|  |
